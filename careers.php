...
<head>
    ...
    <title>pump solutions - careers</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary main-nav navbar-togglable rounded-radius">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="ml-lg-auto list-unstyled m-0">
                    <li><a href="http://localhost/webProject/farm.php" class="btn btn-trans-white btn-circled">Get a quote</a></li>
                </ul>
            </div> <!-- / .navbar-collapse -->
        </nav>
    </div> <!-- / .container -->
...
<?php
$db_connection = mysqli_connect("localhost","root","","careers");
// Check connection
if (mysqli_connect_errno()){
    echo "Failed to connect to MySQL: " . mysqli_connect_error();
}
//define variables and set to empty strings
$username=$email=$subject=$message=$uploadcv="";
//define err variables for form validation
$usernameerr=$emailerr=$subjecterr=$messageerr=$uploadcverr="";
if($_SERVER["REQUEST_METHOD"]=="POST");{
    ...
    if(empty($_POST["file"])){
        $uploadcverr="please input your cv";
    }else{
        $uploadcv=validate_data($_POST["file"]);
    }
}
...
$insert_user = mysqli_query($db_connection, "INSERT INTO `career_form` (username, email, subject,message,uploadcv) VALUES ('$username', '$email', '$subject','$message','$uploadcv')");
            ...
            <div class="col-md-12 col-lg-8">
                <div class="banner-content text-center text-lg-left">
                    ...
                    <h1 style="color:cadetblue;" >
                        welcome to pump solutions career page
                    </h1>
                   <div>
                       <h3 style="color:lightskyblue;">job description</h3>
                       <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet aperiam consequatur corporis distinctio eveniet, expedita incidunt labore minus
                           molestias nam non provident, quidem quis quod ratione rem, repudiandae soluta. Dolore.</p>
                   </div>
                    <hr>
                    <div style="background-color: lightyellow">
                        <h3> Adept in the following programming languages</h3>
                        <ul>
                            <li>Python</li>
                            <li>Java</li>
                            <li>C++</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-auto-12 ">
                                <div class="banner-contact-form bg-white">
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
                                        <div class="form-group">
                                            <input type="text" name="name" id="name" class="form-control" placeholder="your Name"><span class="error">*<?php echo $usernameerr;?></span>
                                        ...
                                        <div>
                                            ...
                                            <span class="error">*<?php echo $uploadcverr;?></span>
                                        </div>
