                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarWelcome">
                            ...
                            <a class="dropdown-item " href="index-3.php">
                                Home-3
                            </a>
                            <a class="dropdown-item " href="index-4.php">
                                Home-4
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a href="service.php" class="nav-link js-scroll-trigger">
                            Services
                        </a>
                    </li>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item ">
                        <a href="project.php" class="nav-link js-scroll-trigger">
                            Projects
                        </a>
                    </li>
                    ...
                    <div class="col-lg-4 col-md-6 p-0">
                        <div class="work-block">
                            ...
                            <div class="overlay-content-block">
                                ...
                                <p>Web Development</p>
                                <a href="single-project.php"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 p-0">
