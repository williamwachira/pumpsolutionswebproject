...
$check_email = mysqli_query($db_connection, "SELECT `user_email` FROM `login_registration.users` WHERE user_email = '$user_email'");
...
$insert_user = mysqli_query($db_connection, "INSERT INTO `login_registration.users` (username, user_email, user_password) VALUES ('$username', '$user_email', '$user_hash_password')");
